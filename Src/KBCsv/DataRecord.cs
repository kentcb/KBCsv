namespace KBCsv
{
    ...
    /// <see cref="KBCsv.HeaderRecord"/> (exposed via <see cref="HeaderRecord"/>), in which case values in the data record may also be accessed via a column name.
    /// </para>
    /// </remarks>
    public sealed class DataRecord : RecordBase, IEquatable<DataRecord>
    {
        ...
        /// <summary>
        /// Gets the <see cref="KBCsv.HeaderRecord"/> in use by this data record.
        /// </summary>
        /// <remarks>
        /// In order to get or set values in a data record via their column name, a header record must be provided. This property gets the <see cref="KBCsv.HeaderRecord"/> that
