namespace KBCsv
{
    ...
    /// </para>
    /// <para>
    /// Records can be written with <see cref="O:KBCsv.CsvWriter.WriteRecord"/> and <see cref="WriteRecords"/> methods (or their async counterparts,
    /// <see cref="O:KBCsv.CsvWriter.WriteRecordAsync"/> and <see cref="WriteRecordsAsync"/>). Doing so will increase <see cref="RecordNumber"/> accordingly.
    /// </para>
    /// </remarks>
    /// <threadsafety>
    ...
    /// </para>
    /// <code source="..\Src\KBCsv.Examples.CSharp\Program.cs" region="WriteCSVToString" lang="cs"/>
    /// <code source="..\Src\KBCsv.Examples.VB\Program.vb" region="WriteCSVToString" lang="vb"/>
    /// </example>
    /// <example>
    /// <para>
    ...
    /// </para>
    /// <code source="..\Src\KBCsv.Examples.CSharp\Program.cs" region="WriteCSVToStreamWithForcedDelimiting" lang="cs"/>
    /// <code source="..\Src\KBCsv.Examples.VB\Program.vb" region="WriteCSVToStreamWithForcedDelimiting" lang="vb"/>
    /// </example>
    /// <example>
    /// <para>
    ...
    /// </para>
    /// <code source="..\Src\KBCsv.Examples.CSharp\Program.cs" region="ReadCSVFromFileAndWriteToTabDelimitedFile" lang="cs"/>
    /// <code source="..\Src\KBCsv.Examples.VB\Program.vb" region="ReadCSVFromFileAndWriteToTabDelimitedFile" lang="vb"/>
    /// </example>
