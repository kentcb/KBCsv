namespace KBCsv
{
    ...
    /// accessed by index, or - if a <see cref="KBCsv.HeaderRecord"/> has been assigned - by column names.
    /// </para>
    /// <para>
    /// Data can be skipped via <see cref="O:KBCsv.CsvReader.SkipRecord"/> or <see cref="O:KBCsv.CsvReader.SkipRecords"/> (or their async counterparts,
    /// <see cref="O:KBCsv.CsvReader.SkipRecordAsync"/> and <see cref="O:KBCsv.CsvReader.SkipRecordsAsync"/>). Skipping data is faster than reading (and discarding)
    ...
    /// </para>
    /// <code source="..\Src\KBCsv.Examples.CSharp\Program.cs" region="ReadCSVFromString" lang="cs"/>
    /// <code source="..\Src\KBCsv.Examples.VB\Program.vb" region="ReadCSVFromString" lang="vb"/>
    /// </example>
    /// <example>
    /// <para>
    /// The following example uses <see cref="FromCsvString"/> to parse data in a <see cref="String"/>. White space is preserved:
    /// </para>
    /// <code source="..\Src\KBCsv.Examples.CSharp\Program.cs" region="ReadCSVFromStringPreservingWhiteSpace" lang="cs"/>
    /// <code source="..\Src\KBCsv.Examples.VB\Program.vb" region="ReadCSVFromStringPreservingWhiteSpace" lang="vb"/>
    /// </example>
    /// <example>
    /// <para>
    /// The following example reads data from a file, where values are tab-separated and delimited with single quotes:
    /// </para>
    /// <code source="..\Src\KBCsv.Examples.CSharp\Program.cs" region="ReadTabDelimitedDataFromFile" lang="cs"/>
    /// <code source="..\Src\KBCsv.Examples.VB\Program.vb" region="ReadTabDelimitedDataFromFile" lang="vb"/>
    /// </example>
    /// <example>
    /// <para>
    /// The following example reads data from an underlying UTF-8 encoded <see cref="Stream"/>. It treats the first record as a <see cref="KBCsv.HeaderRecord"/>, thus enabling
    /// the data to be accessed via column names.
    /// </para>
    /// <code source="..\Src\KBCsv.Examples.CSharp\Program.cs" region="ReadCSVFromStream" lang="cs"/>
    /// <code source="..\Src\KBCsv.Examples.VB\Program.vb" region="ReadCSVFromStream" lang="vb"/>
    /// </example>
    /// <example>
    /// <para>
    /// The following example reads data from a file. It explicitly assigns a <see cref="HeaderRecord"/> and skips every other record:
    /// </para>
    /// <code source="..\Src\KBCsv.Examples.CSharp\Program.cs" region="ReadCSVFromFileWithExplicitHeader" lang="cs"/>
    /// <code source="..\Src\KBCsv.Examples.VB\Program.vb" region="ReadCSVFromFileWithExplicitHeader" lang="vb"/>
    /// </example>
    /// <example>
    /// <para>
    ...
    /// </para>
    /// <code source="..\Src\KBCsv.Examples.CSharp\Program.cs" region="ReadCSVFromFileAsynchronously" lang="cs"/>
    /// <code source="..\Src\KBCsv.Examples.VB\Program.vb" region="ReadCSVFromFileAsynchronously" lang="vb"/>
    /// </example>
