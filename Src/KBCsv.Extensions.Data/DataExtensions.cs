namespace KBCsv.Extensions.Data
{
    ...
    /// </para>
    /// <code source="..\Src\KBCsv.Examples.CSharp\Program.cs" region="FillDataTableFromCSVFile" lang="cs"/>
    /// <code source="..\Src\KBCsv.Examples.VB\Program.vb" region="FillDataTableFromCSVFile" lang="vb"/>
    /// </example>
    /// <example>
    /// <para>
    /// The following example uses <see cref="WriteCsv(DataTable, CsvWriter)"/> to write the data in a <see cref="DataTable"/> out as CSV:
    /// </para>
    /// <code source="..\Src\KBCsv.Examples.CSharp\Program.cs" region="WriteDataTableToCSV" lang="cs"/>
    /// <code source="..\Src\KBCsv.Examples.VB\Program.vb" region="WriteDataTableToCSV" lang="vb"/>
    /// </example>
    /// <example>
    /// <para>
    ...
    /// </para>
    /// <code source="..\Src\KBCsv.Examples.CSharp\Program.cs" region="FillDataTableFromCSVFileThenWriteSomeToStringAsynchronously" lang="cs"/>
    /// <code source="..\Src\KBCsv.Examples.VB\Program.vb" region="FillDataTableFromCSVFileThenWriteSomeToStringAsynchronously" lang="vb"/>
    /// </example>
