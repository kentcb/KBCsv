...
namespace Kent.Boogaart.KBCsv
{
	...
	public sealed class DataRecord : RecordBase
	{
		...
		/// </param>
		public DataRecord(HeaderRecord headerRecord, string[] values) : this(headerRecord, values, false)
		{
		}
		...
		/// </param>
		public DataRecord(HeaderRecord headerRecord, string[] values, bool readOnly) : base(values, readOnly)
		{
			_headerRecord = headerRecord;
		}
		...
		public override bool Equals(object obj)
		{
			...
			DataRecord record = obj as DataRecord;
