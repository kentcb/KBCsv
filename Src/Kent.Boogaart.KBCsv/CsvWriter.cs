...
namespace Kent.Boogaart.KBCsv
{
	...
	public class CsvWriter : IDisposable
	{
		...
		/// </param>
		public CsvWriter(Stream stream) : this(stream, Encoding.Default)
		{
		}
		...
		/// </param>
		public CsvWriter(Stream stream, Encoding encoding) : this(new StreamWriter(stream, encoding))
		{
		}
		...
		/// </param>
		public CsvWriter(string path) : this(path, false, Encoding.Default)
		{
		}
		...
		/// The encoding for the data in <paramref name="path"/>.
		/// </param>
		public CsvWriter(string path, bool append, Encoding encoding) : this(new StreamWriter(path, append, encoding))
		{
		}
